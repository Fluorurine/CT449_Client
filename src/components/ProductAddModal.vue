        ...
        <div v-for="(item, index) in productvariant" :key="index" class="mb-6">
          <div class="grid gap-6 mb-6 grid-cols-4">
            ...
            <button
              ...
              type="button"
              class="text-white block bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base mt-8 w-auto text-center h-9"
            >
              Xóa
            </button>
          </div>
...
const productsubmit = async () => {
  ...
  if (result.err) {
    ...
    error.value = ''
    sucessstatus.value = 'Đã thêm sản phẩm thành công'
